...
async function main() {
  ...
  const roles = [
    ...
    { code: 'TL', name: 'Szefostwo tenanta', description: 'Dostęp do całej dokumentacji własnej firmy', isSystem: true, permissions: ['box.read', 'folder.read', 'document.read', 'order.read', 'order.create', 'hr.view', 'attachment.read', 'search.own', 'report.view'] },
