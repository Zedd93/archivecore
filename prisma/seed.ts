...
async function main() {
  ...
  const roles = [
    ...
    { code: 'TL', name: 'Szefostwo tenanta', description: 'Dostęp do całej dokumentacji własnej firmy', isSystem: true, permissions: ['box.read', 'folder.read', 'document.read', 'hr.view', 'attachment.read', 'search.own', 'report.view'] },
    { code: 'TE', name: 'Pracownik tenanta', description: 'Dostęp do dokumentacji przypisanego działu', isSystem: true, permissions: ['box.read', 'folder.read', 'document.read', 'attachment.read', 'search.own'] },
