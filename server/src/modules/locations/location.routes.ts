...
router.post('/', ...auth, requirePermission(Permissions.LOCATION_WRITE), validate(createLocationSchema), auditLog('location', 'location.create'), (r, s, n) => locationController.create(r, s, n));
router.put('/:id', ...auth, requirePermission(Permissions.LOCATION_WRITE), validate(updateLocationSchema), auditLog('location', 'location.update'), (r, s, n) => locationController.update(r, s, n));
